...
namespace Argus.Platform.Migrations
{
    ...
    [Migration("20240727064019__refater-db")]
    partial class _refaterdb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Argus.Platform.Core.Common.Tenants", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.Platform.Core.JobsWorkflowEvents.JobsWorkflowEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.Platform.Core.JobsWorkflowEvents.JobsWorkflowEvent", b =>
                {
                    b.HasOne("Argus.Platform.Core.Jobs.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
